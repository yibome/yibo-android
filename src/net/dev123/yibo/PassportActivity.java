...
import net.dev123.yibo.service.task.PassportLoginTask;
import net.dev123.yibo.service.task.PassportRegisterTask;
...
public class PassportActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.passport_login);
