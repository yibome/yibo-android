...
public class Theme extends AbsTheme {
	...
	public static final String DEFAULT_PACKAGE_NAME = "net.dev123.yibo";
    ...
    public Uri getResourcesUri(String resName) {
        ...
        StringBuilder sb = new StringBuilder("/.yibo/skins/");
    ...
    private void staticInit() {
        synchronized(mStaticInit) {
        	if (!isInitialize) {
                ...
                currentPackageName = preferences.getString(PREFS_KEY_PACKAGE_NAME, DEFAULT_PACKAGE_NAME);
