...
import net.dev123.yibo.service.task.MetionsPageDownTask;
import net.dev123.yibo.service.task.MetionsReadLocalTask;
...
public class MentionsListAdapter extends CacheAdapter<Status> {
	...
	public NotificationEntity getNotificationEntity(UnreadCount unreadCount) {
		...
		entity.setContentText(account.getServiceProvider().getServiceProviderName() + ": " + 
