...
public final class Constants {
	...
	public static final String PREFS_NAME_APP_SETTING   = "YIBO_APP_SETTING"; //应用设置数据存储 SharedPreferences名称/
	...
	public static final String PREFS_NAME_APP_TEMP          = "YIBO_APP_TEMP";	   //临时存储数据SharedPreferences名称
	...
	public static final int SP_ACCOUNT_LIMIT                    = 5;     // 每个SP的帐号数量限制最多为5个
	...
	//应用定义的uri地址
	public static final Uri OAUTH_CALLBACK_SINA    = Uri.parse("yibo://oauth/sina"); 	// 新浪  OAUTH 回调地址
	public static final Uri OAUTH_CALLBACK_SOHU    = Uri.parse("yibo://oauth/sohu");    // 搜狐 OAUTH 回调地址
	public static final Uri OAUTH_CALLBACK_NETEASE = Uri.parse("yibo://oauth/netease"); // 网易 OAUTH 回调地址
	public static final Uri URI_PERSONAL_INFO      = Uri.parse("yibo://info/");         // 用户资料查看地址
	public static final Uri URI_TOPIC              = Uri.parse("yibo://topic/");        // 话题查看地址
	...
	public static final String PICTURE_NAME_PREFIX       = "yibo_";          // 用户保存图片时图片名称前缀
