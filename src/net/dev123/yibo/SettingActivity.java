...
import net.dev123.yibo.service.task.ImageCacheCleanTask;
...
public class SettingActivity extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		imageFolder.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
			@Override
			public boolean onPreferenceClick(Preference preference) {
				YiBoApplication yibo = (YiBoApplication) SettingActivity.this.getApplication();
				String folderPath = yibo.getImageFolder();
