...
public class CacheManager {
	...
	private CacheManager() {
		...
		//图片缓冲Cache;
		ImageCache imageCache = new ImageCache(YiBoApplication.getSdcardCachePath(), 
...
//	}
	...
	public Cache getCache(Class<?> clazz) {
		...
		if (cache == null && clazz.equals(ImageCache.class)) {
			String sdcardCachePath = YiBoApplication.getSdcardCachePath();
			ImageCache imageCache = new ImageCache(sdcardCachePath, YiBoApplication.getInnerCachePath());
